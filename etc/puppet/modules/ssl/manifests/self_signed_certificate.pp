...
define ssl::self_signed_certificate (
  ...
  validate_legacy(String,'validate_string',$email_address)
  validate_legacy(String,'validate_re',$country,'^(|[a-zA-Z]{2})$')
  # validate_legacy(String,'validate_string',$state)
  # validate_legacy(String,'validate_string',$locality)
  validate_legacy(String,'validate_string',$organization)
  validate_legacy(String,'validate_string',$unit)
  validate_legacy(String,'validate_string',$subject_alt_name)
  validate_legacy(Numeric,'validate_re',$days,'^\d+$')
  validate_legacy(String,'validate_absolute_path',$directory)
